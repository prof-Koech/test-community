...
const r=(0,m.runTask)(this,(()=>{this.msgDataManager.fetchReactors(this.args.viewData.messageUrnForReactors,t,this.args.viewData.conversationUrn).then((r=>{if(!(0,y.isDestroying)(this)&&void 0!==this.delayedShowReactorTasks[i]&&r.length){const a=this.reactionListEl.querySelector(`[data-reaction-id="${i}"]`)
...
this.emojiI18nName=l?this.i18n.lookupTranslation(E.default,l)():i
...
this.displayedReactorNames=void 0}}onReactorsKeyUp(e,t){"keyup"===t.type&&t.which===l.default.KEYCODES.ESC&&this.stopShowingReactors(e)}},U=(0,r.default)(A.prototype,"i18n",[T],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),C=(0,r.default)(A.prototype,"msgDataManager",[D],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),I=(0,r.default)(A.prototype,"authenticatedUser",[M],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),q=(0,r.default)(A.prototype,"a11yNotification",[P],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),H=(0,r.default)(A.prototype,"clientSensor",[O],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),B=(0,r.default)(A.prototype,"jet",[x],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),F=(0,r.default)(A.prototype,"reactionBeingViewed",[p.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),$=(0,r.default)(A.prototype,"triggerData",[p.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),K=(0,r.default)(A.prototype,"displayedReactorNames",[p.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),L=(0,r.default)(A.prototype,"emojiI18nName",[p.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),V=(0,r.default)(A.prototype,"reactorListStyle",[p.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),W=(0,r.default)(A.prototype,"tracking",[z],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),(0,r.default)(A.prototype,"toggleExistingReaction",[f.action],Object.getOwnPropertyDescriptor(A.prototype,"toggleExistingReaction"),A.prototype),(0,r.default)(A.prototype,"addReactionToMessageEvent",[f.action],Object.getOwnPropertyDescriptor(A.prototype,"addReactionToMessageEvent"),A.prototype),(0,r.default)(A.prototype,"showReactors",[f.action],Object.getOwnPropertyDescriptor(A.prototype,"showReactors"),A.prototype),(0,r.default)(A.prototype,"stopShowingReactors",[f.action],Object.getOwnPropertyDescriptor(A.prototype,"stopShowingReactors"),A.prototype),(0,r.default)(A.prototype,"onReactorsKeyUp",[f.action],Object.getOwnPropertyDescriptor(A.prototype,"onReactorsKeyUp"),A.prototype),A))}))
